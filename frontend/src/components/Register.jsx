        ...
        <div className='card-body'>
          <form>
            <div className='form-group'>
              ...
              <input type="text" name="userName" className='form-control' placeholder='User Name' id='username' />
            </div>
            ...
            <div className='form-group'>
              ...
              <input type="password" name="confirmPassword" className='form-control' placeholder='Confirm Password' id='confirmPassword' />
            </div>
